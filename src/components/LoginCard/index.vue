  ...
  <div>
    <div class="login-card" @mouseleave="LoginCardOver">
      ...
      <div class="flower">
        <p>鲜花:</p>
        <span> 100朵</span>
        <svg t="1698031419803" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="6121" width="16" height="16">
          <path
          ...
          <path
            ...
            fill="#E66978" p-id="6124"></path>
          <path
            d="M489.6 741c-6.9 5.2-21.9 14.5-41.6 14.5-39.2 0-79.2-35.6-116.7-103.3 6.6-0.3 13-0.4 19.2-0.4 61.2 0 104.4 13.7 125.1 39.6 15 18.9 15 40 14 49.6z"
            fill="#FFD976" p-id="6125"></path>
          <path
          ...
          <path
            ...
            fill="#FFAEBF" p-id="6127"></path>
          <path
            d="M576.1 815c-19.7 0-34.8-9.3-41.6-14.5-1-9.7-1-30.8 14.1-49.6 20.6-25.9 63.9-39.6 125.1-39.6 6.2 0 12.6 0.1 19.2 0.4C655.4 779.4 615.3 815 576.1 815z"
            fill="#FFD976" p-id="6128"></path>
        </svg>
      </div>
      <!-- 等级 -->
      <div class="level">
