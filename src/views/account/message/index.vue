    ...
    <div class="form">
      <el-form :model="form" label-width="120px">
        ...
        <el-form-item label="个性签名：" label-width="200px">
          <el-input v-model="form.signature" type="textarea" style="width: 500px" :placeholder="userStore.userInfo.signature" />
        </el-form-item>
        ...
        <el-form-item label="生日：" label-width="200px">
          <el-date-picker v-model="form.birthdate" type="date" placeholder="选择日期" clearable format="YYYY/MM/DD" value-format="YYYY-MM-DD" />
        </el-form-item>
...
const form = reactive({
  ...
  userId: userStore.userInfo.userId, //userid
