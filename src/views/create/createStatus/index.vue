<template>
  <div>
    ...
    <div class="form">
      ...
      <h1>3.配图</h1>
      <el-upload v-model:file-list="fileList" action="http://172.16.40.32:8083/common/upload" list-type="picture-card" :on-preview="handlePictureCardPreview" :on-remove="handleRemove" :on-success="handleSuccess">
